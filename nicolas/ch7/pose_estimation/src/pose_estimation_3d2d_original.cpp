...
//   }
    ...
    Mat r, t;
    solvePnP(pts_3d, pts_2d, K, Mat(), r, t, false); // call OpenCV's PnP to solve, choose EPNP, DLS and other methods
    Mat R;
    cv::Rodrigues(r, R); // r is a rotation vector form, converted to a matrix using Rodrigues formula
