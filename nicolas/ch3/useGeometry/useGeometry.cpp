...
void printQuaternion(char text[], TTypeQuat quat){
...
int main(int argc, char **argv){
    ...
    /* ===================================================================== */
    /*  Rotate a vector/point with a quaternion and use overloaded multiplication  */
    /* ===================================================================== */
    /* ----- Method 1, returns a Vector3d ----- */
    Vector3d v1_new = q1*v1;  // Note that the math is: v' = q.v (Quaternion*Point)
    ...
    Quaterniond q_v1_new = q1*q_v1*q1.inverse();  // Note that the math is: v' = q.v.inv(q) (Quaternion*Quaternion of a Point*Inverse Quaternion)
