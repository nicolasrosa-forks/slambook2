 ...
 */
void BFMatcher_custom(const vector<DescType> &desc1, const vector<DescType> &desc2, vector<cv::DMatch> &matches);
...
int main(int argc, char **argv) {
    ...
    /* Save */
    imwrite("orb_self_matches.png", image_matches);
